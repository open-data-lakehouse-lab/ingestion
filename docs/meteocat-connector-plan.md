...
## Status: Real mode for station metadata, variable metadata and measured data (Opt-in)
...
1. **Endpoint Selection**: Identified `stations-metadata`, `variables-metadata` and `measured-variable` endpoints. ✓
